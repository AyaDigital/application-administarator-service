...
const CreateDegree = ({
	...
	const [updateItem, {isLoading: IsEmergencyUpdating, isSuccess: IsEmergencyUpdated}] = useEditMedicalDegreeMutation();
	const [createItem, { isLoading: IsEmergencyCreating, isSuccess: isEmergencyCreated }] = useCreateMedicalDegreeMutation();
	const [skip, setSkip] = useState(true);

	const {isLoading: isOneInsuranceFetching, isSuccess: isOneEmergencyFetched, data: oneItem} = useGetMedicalDegreeByIdQuery(id, {
		skip
	});
	...
	useEffect(() => {
		...
		setCode(oneItem?.code);
		setIsActive(oneItem?.active);
		setDescription(oneItem?.description)
	}, [oneItem, isOneEmergencyFetched])
